...
public class Constants {
	...
	public static final String CANCLEUPLOAD_SUCCESSS = "cancleuploadSuccess";
    public static final String UPLOAD_FAILURE_1 = "cancleFailure1";
    public static final String UPLOAD_FAILURE_2 = "cancleFailure2";
    public static final String UPLOAD_FAILURE_3 = "cancleFailure3";
    public static final String WECHAT_SUCCESS = "wechatsuccess";
